...
class Pharmacy(models.Model):
    ...
    country = fields.Many2one('res.country', string='Country', default=lambda self: self.env.ref('base.vn', raise_if_not_found=False), readonly=False)
    city = fields.Char('City', required=True)
    address = fields.Char('address')
    dateStartPermanence = fields.Datetime('Start of Permanence')
    dateEndPermanence = fields.Datetime('End of Permanence')
    location_link = fields.Char("Link to pharamcy location")
    ...
    def create_or_update_from_google_places(self, pharmacy_data, city_name):
        ...
        pharmacy_values = {
            ...
            'location_link': 'https://www.google.com/maps/search/?api=1&query=' + pharmacy_name + '+in+' + city_name
        }
